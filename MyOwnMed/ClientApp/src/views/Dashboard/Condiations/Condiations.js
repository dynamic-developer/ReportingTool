...
import '../../../scss/Condiations/_condiations.scss';
import CondiationCatDetails from './CondiationCatDetails';
        ...
        <Row>
          <Col>
            <Card>
              <CardBody>
                <Row>
                  <CondiationCatDetails className="condiation-table" filter={this.state.filter} mamberId={this.state.mamberId} />
                </Row>
              </CardBody>
            </Card>
          </Col>
